...
export class WasmLattice {
    ...
    __destroy_into_raw() {
        ...
        this.__wbg_ptr = 0;
        WasmLatticeFinalization.unregister(this);
        return ptr;
    }
    ...
    */
    get_meshes(visible) {
        const ptr0 = passArray32ToWasm0(visible, wasm.__wbindgen_malloc);
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.wasmlattice_get_meshes(this.__wbg_ptr, ptr0, len0);
    ...
    */
    get_solve_count() {
        try {
            ...
            wasm.wasmlattice_get_solve_count(retptr, this.__wbg_ptr);
    ...
    */
    set_upgrades(upgrades) {
        wasm.wasmlattice_set_upgrades(this.__wbg_ptr, upgrades);
    }
    /**
    * @param {number} dt
    * @returns {number}
    ...
    */
    alter(difference) {
        wasm.wasmlattice_alter(this.__wbg_ptr, difference);
    }
    /**
    * @returns {number}
    */
    count() {
        const ret = wasm.wasmlattice_count(this.__wbg_ptr);
        return ret >>> 0;
    }
}
