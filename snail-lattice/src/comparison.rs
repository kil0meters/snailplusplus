...
const TICK_AMOUNT: usize = 1_000_000_000_000;
...
fn main() {
    ...
    let mut tremaux = SnailLattice::new("tremaux", 5, 7, 100, 0xDEAD);
    ...
    println!("hold_left: {} maze fragments", hold_left.tick(TICK_AMOUNT));
    println!("tremaux:   {} maze fragments", tremaux.tick(TICK_AMOUNT));
